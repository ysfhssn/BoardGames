...
from Puissance4.Players import random_move, minimax_ab, master, mcts
import time
JOUEURS_TREE = [minimax_ab]
...
def main():
    ...
    for i in range(NUM_ROUNDS):
        ...
        if game.GUI:
            ...
            puissance4.draw_board(game_info)
        ...
        while not game.is_game_over(game_info):
            ...
            #game.print_game(game_info)
            if game.GUI: puissance4.draw_board(game_info)
